...
Project map written, repository tooled (CI, hooks, skills). No phase implemented yet.

## Development

```bash
npm install
npm run validate        # format, shellcheck, compose validation, specs completeness — what CI runs
```
